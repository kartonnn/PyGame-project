...
def levels():
    back_button = ImageButton(weight / 2 - (252 / 2), height / 5, 252, 74, 'BACK', 'start button.png ',
                              'start button 2.png',
                              'negromkiy-korotkiy-klik.mp3')
    first = ImageButton(weight / 2 - (252 / 2), height / 5 * 2, 252, 74, 'LEVEL 1', 'start button.png ',
                        'start button 2.png',
                        'negromkiy-korotkiy-klik.mp3')
    second = ImageButton(weight / 2 - (252 / 2), height / 5 * 3, 252, 74, 'LEVEL 2', 'start button.png ',
                         'start button 2.png',
                         'negromkiy-korotkiy-klik.mp3')
    third = ImageButton(weight / 2 - (252 / 2), height / 5 * 4, 252, 74, 'LEVEL 3', 'start button.png ',
                        'start button 2.png',
                        'negromkiy-korotkiy-klik.mp3')
    running = True
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()
                sys.exit()
            for btn in [back_button, first, second, third]:
                btn.handle_event(event)
            if event.type == pygame.USEREVENT and event.button == first:
                pygame.quit()
                pass
                # game = Game(1)
                # game.run()

            if event.type == pygame.USEREVENT and event.button == second:
                pygame.quit()
                pass
                # game = Game(2)
                # game.run()

            if event.type == pygame.USEREVENT and event.button == third:
                pygame.quit()
                pass
                # game = Game(3)
                # game.run()
...
def main_menu():
    ...
    start_button = ImageButton(weight / 2 - (252 / 2), 200, 252, 74, 'PLAY', 'start button.png ', 'start button 2.png',
                               'negromkiy-korotkiy-klik.mp3')
    options_button = ImageButton(weight / 2 - (252 / 2), 350, 252, 74, 'OPTIONS', 'start button.png ',
                                 'start button 2.png',
                                 'negromkiy-korotkiy-klik.mp3')
    exit_button = ImageButton(weight / 2 - (252 / 2), 500, 252, 74, 'start button.png ', 'start button 2.png',
                              'negromkiy-korotkiy-klik.mp3')
...
def change_audio_mode():
    ...
    back_button = ImageButton(weight / 2 - (252 / 2), 650, 252, 74, 'BACK', 'start button.png ', 'start button 2.png',
                              'negromkiy-korotkiy-klik.mp3')
    music = ImageButton(weight / 2 - 250, 220, 252, 74, 'MUSIC', 'start button.png ', None,
                        None)
